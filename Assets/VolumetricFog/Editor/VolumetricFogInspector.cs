				...
				public class VolumetricFogInspector : Editor {
								...
								public override void OnInspectorGUI () {
												...
												if (_fog.renderOpaque) {
																...
																TRANSPARENT_PASS_MODE prevMode = _fog.transparencyMode;
																_fog.transparencyMode = (TRANSPARENT_PASS_MODE)EditorGUILayout.EnumPopup (_fog.transparencyMode);
																if (_fog.transparencyMode != prevMode)
																				GUIUtility.ExitGUI ();
